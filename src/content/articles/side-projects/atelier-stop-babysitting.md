...
description: "A self-hosted Firecracker orchestrator that gives every AI coding agent its own VM sandbox: dispatch tasks like a kanban board, review results anywhere."
